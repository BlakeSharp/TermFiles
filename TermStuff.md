# Terminal Usage Stuff
## Plugin stuff
**wd**
- ```wd add (name)``` While in the dir. you want to add to warp drive
- ```wd (name)``` To access some dir. from warp drive
- ```wd list``` To see a list of all warp drives
****
**copypath**
- ```copypath``` copies current directory path
- ```copypath (file)``` copies the path to a specific file
****
**htop**
- ```[sudo] htop``` to see process mangagement
****
**tldr**
